...
HIDDEN void sysTrapHandler(unsigned int KUp); /*Syscall Handler*/
HIDDEN void tlbTrapHanlder(); /*TLB Trap Handler*/
HIDDEN void prgmTrapHandler(); /*Program Trap Handler*/
...
void getCPUTime(cpu_t *resultAddress); /*SYS6*/
